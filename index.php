...
<body>
	...
	<nav>
		<a class="navbar-brand logo " href='#' style="color: green; font-weight: bold;
	line-height: 70px; font-size: 25px;
	position: relative;
	left: 5%; top: -10px;">W-School</a>

		<ul >
			<li ><a href="" style="color: green; font-weight: bold;
	line-height: 70px; font-size: 25px;">Home</a></li>
			<li ><a href="" style="color: green; font-weight: bold;
	line-height: 70px; font-size: 25px;">Contact</a></li>
			<li ><a href="" style="color: green; font-weight: bold;
	line-height: 70px; font-size: 25px;">Admission</a></li>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<p>MEMS has been committed to global learning long before it became an indispensable feature of contemporary education. Established in 1997, we proudly stand as the 1st English medium school in India to adopt both Pearson Edexcel and Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.MEMS has been committed to global learning long before it became an indispensable feature of contemporary education. Established in 1997, we proudly stand as the 1st English medium school in India to adopt both Pearson Edexcel and Cambridge curriculum (in O and A levels), drawing together students in a vibrant, academically challenging, and encouraging environment where manifold viewpoints are prized and celebrated.</p>
